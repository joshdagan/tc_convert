...
## Setup — only needed for BCAST countdown calibration

If you need to use the **Run Calibration** feature (which reads the visible BCAST countdown clock), you need to install some extra tools first. You only need to do this once.

1. Double-click **`install.bat`**
2. Wait for it to finish
3. If you see **"pip is not recognized"**, close the window and double-click `install.bat` again

If you only use BTGL/BTGR elapsed or Time of Day conversion, skip this entirely.
