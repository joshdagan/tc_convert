...
def check_dependencies():
    ...
    try:
        ...
        errors.append({
            ...
            "detail":  "Pillow is required for OCR frame processing.",
            "fix":     inst["pillow"]["fix"],
    ...
    try:
        ...
        errors.append({
            ...
            "detail":  "Tesseract is needed for automatic BCAST clock calibration. You can still use manual sync without it.",
